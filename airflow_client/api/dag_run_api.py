...
class DAGRunApi(object):
    ...
    def airflow_api_connexion_endpoints_dag_run_endpoint_post_dag_run(self, dag_id, dag_run, **kwargs):  # noqa: E501
        """Trigger a DAG Run  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.airflow_api_connexion_endpoints_dag_run_endpoint_post_dag_run(dag_id, dag_run, async_req=True)
        >>> result = thread.get()
        ...
        return self.airflow_api_connexion_endpoints_dag_run_endpoint_post_dag_run_with_http_info(dag_id, dag_run, **kwargs)  # noqa: E501

    def airflow_api_connexion_endpoints_dag_run_endpoint_post_dag_run_with_http_info(self, dag_id, dag_run, **kwargs):  # noqa: E501
        """Trigger a DAG Run  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.airflow_api_connexion_endpoints_dag_run_endpoint_post_dag_run_with_http_info(dag_id, dag_run, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method airflow_api_connexion_endpoints_dag_run_endpoint_post_dag_run" % key
                )
        ...
        if self.api_client.client_side_validation and ('dag_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `dag_id` when calling `airflow_api_connexion_endpoints_dag_run_endpoint_post_dag_run`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('dag_run' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `dag_run` when calling `airflow_api_connexion_endpoints_dag_run_endpoint_post_dag_run`")  # noqa: E501
    ...
    def get_dag_runs_batch(self, list_dag_runs_form, **kwargs):  # noqa: E501
        """Get all DAG Runs from all DAGs  # noqa: E501
